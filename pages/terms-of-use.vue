  ...
  <div class="body">
    <div class="container">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Craftspace.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        copyright agent via email at tngeene27@gmail.com and include in Your
      ...
      <p>
        ...
        Application may also be subject to other local, county, national, or
        international laws.
      </p>
      ...
      <ul>
        <li>
          <a href="mailto:tngeene27@gmail.com"> tngeene27@gmail.com</a>
        </li>
      </ul>
    </div>
  </div>
...
export default {
  head() {
    return {
      title: 'Craftspace Homes | Terms and conditions'
    }
  }
}
</script>
